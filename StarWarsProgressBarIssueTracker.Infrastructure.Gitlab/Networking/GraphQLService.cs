...
//         GitlabClient client)
//     {
//         _projectId = configuration.GetValue<string>("ProjectPath") ?? throw new ArgumentException("Project path must not be null!");
//         _client = client;
//     }
//
...
//             ProjectPath = _projectId,
//             DueDate = release.ReleaseDate?.ToString("yyyy-MM-dd"),
